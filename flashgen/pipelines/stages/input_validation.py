...
from flashgen.models.vision_utils import load_image, load_video, pil_to_numpy, numpy_to_pt, normalize, resize
from flashgen.pipelines.pipeline_batch_info import ForwardBatch
from flashgen.pipelines.stages.base import PipelineStage
from flashgen.pipelines.stages.validators import (StageValidators, VerificationResult)
from flashgen.utils import best_output_size
...
class InputValidationStage(PipelineStage):
    ...
    def _generate_seeds(self, batch: ForwardBatch, fastvideo_args: FlashgenArgs):
