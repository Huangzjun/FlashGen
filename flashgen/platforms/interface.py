...
class Platform:
    ...
    device_control_env_var: str = "FLASHGEN_DEVICE_CONTROL_ENV_VAR_PLACEHOLDER"
    ...
    def get_device_capability(
        ...
        """Return device capability metadata when the backend exposes it."""
        return None
    ...
    def get_device_communicator_cls(cls) -> str:
        ...
        """
        return "flashgen.distributed.device_communicators.base_device_communicator.DeviceCommunicatorBase"  # noqa
