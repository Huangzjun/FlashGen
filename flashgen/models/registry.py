...
_SUBPROCESS_COMMAND = [sys.executable, "-m", "flashgen.models.dits.registry"]
...
ModelRegistry = _ModelRegistry({
    ...
    _LazyRegisteredModel(
        module_name=(f"flashgen.models.{component_name}.{mod_relname}"
                     if mod_relname else f"flashgen.models.{component_name}"),
