...
# Copyright 2025 The Flashgen Authors.
...
from flashgen.models.loader.utils import (get_param_names_mapping,
                                           hf_to_custom_state_dict)
from flashgen.models.loader.weight_utils import safetensors_weights_iterator
from flashgen.utils import set_mixed_precision_policy, is_pin_memory_available
...
def shard_model(
    ...
    *,
    ...
    use_size_filtering = os.environ.get("FLASHGEN_FSDP2_AUTOWRAP", "0") == "1"
    ...
    if use_size_filtering:
        ...
        min_params = int(os.environ.get("FLASHGEN_FSDP2_MIN_PARAMS", "10000000"))
