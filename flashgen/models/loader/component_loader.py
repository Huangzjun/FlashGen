...
from flashgen.models.hf_transformer_utils import get_diffusers_config
from flashgen.models.loader.fsdp_load import maybe_load_fsdp_model, shard_model
from flashgen.models.loader.utils import set_default_torch_dtype
from flashgen.models.loader.weight_utils import (
    filter_duplicate_safetensors_files,
    filter_files_not_needed_for_inference,
    pt_weights_iterator,
    safetensors_weights_iterator,
)
from flashgen.models.registry import ModelRegistry
from flashgen.utils import PRECISION_TO_TYPE, is_pin_memory_available
from flashgen.hooks.layerwise_offload import enable_layerwise_offload
    ...
    def load(self, model_path: str, flashgen_args: FlashgenArgs):
        ...
        with set_default_torch_dtype(
            ...
            if is_gen3c and class_name in (
                ...
                from flashgen.models.vaes.gen3c_tokenizer_vae import (
...
class ConditionerLoader(ComponentLoader):
    ...
    defaults from its Flashgen config), then loads
    ...
    def load(self, model_path: str, flashgen_args: FlashgenArgs):
        ...
        from flashgen.configs.models.encoders import (
