...
from flashgen.utils import StoreBoolean
...
class SamplingParam:
    ...
    # (mirrors ``Flashgen-internal/.../LTX2DistilledSamplingParam``):
    ...
    def _from_preset(
        ...
        *model_path*, letting the caller fall back to the legacy
        subclass lookup.
        """
        from flashgen.registry import get_preset_selection
        ...
        from flashgen.api.presets import get_preset
