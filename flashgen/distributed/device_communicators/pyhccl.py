...
from flashgen.distributed.device_communicators.pyhccl_wrapper import (HCCLLibrary, aclrtStream_t, buffer_type,
...
from flashgen.utils import current_stream
...
class PyHcclCommunicator:
    ...
    def __init__(
        ...
        logger.info("Flashgen is using pyhccl")
