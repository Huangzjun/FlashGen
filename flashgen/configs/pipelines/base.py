...
from flashgen.utils import FlexibleArgumentParser, StoreBoolean, shallow_asdict
...
class PipelineConfig:
    ...
    def add_cli_args(parser: FlexibleArgumentParser, prefix: str = "") -> FlexibleArgumentParser:
        ...
        # model_path will be conflicting with the model_path in FlashgenArgs,
        ...
        from flashgen.configs.models.vaes.base import VAEConfig
        VAEConfig.add_cli_args(parser, prefix=f"{prefix_with_dot}vae-config")

        # Add DiT configuration arguments
        from flashgen.configs.models.dits.base import DiTConfig
    ...
    def from_pretrained(cls, model_path: str) -> "PipelineConfig":
        ...
        """
        from flashgen.registry import get_pipeline_config_cls_from_name
