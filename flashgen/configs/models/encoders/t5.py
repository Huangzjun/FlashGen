...
from flashgen.configs.models.encoders.base import (TextEncoderArchConfig, TextEncoderConfig)
...
class T5ArchConfig(TextEncoderArchConfig):
    ...
    # Extra fields present in upstream HF T5Config but unused by Flashgen's
