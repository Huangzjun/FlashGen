...
from flashgen.train.methods.base import TrainingMethod, LogScalar
from flashgen.train.models.base import ModelBase
from flashgen.train.utils.optimizer import (
    build_optimizer_and_scheduler, )
from flashgen.train.utils.config import (
    get_optional_float,
    get_optional_int,
    parse_betas,
)
...
class DMD2Method(TrainingMethod):
    ...
    def _init_optimizers_and_schedulers(self) -> None:
        ...
        if critic_sched_raw is None:
            critic_sched_raw = student_sched
