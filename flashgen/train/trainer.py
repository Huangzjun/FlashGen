...
from flashgen.distributed import get_sp_group, get_world_group
from flashgen.train.callbacks.callback import CallbackDict
from flashgen.train.methods.base import LogScalar, TrainingMethod
from flashgen.train.utils.tracking import build_tracker
...
def _coerce_log_scalar(
    ...
    *,
    ...
    Accelerator tensors stay on device so we avoid a
    device synchronization per accumulation step.
...
class Trainer:
    ...
    def run(
        ...
        *,
        ...
        # Allow method-specific optimization flow.
