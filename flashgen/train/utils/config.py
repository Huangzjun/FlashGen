...
def _build_training_config(
    ...
    *,
    ...
    if preprocessed_data_type != "t2v":
        raise ValueError("FlashGen NPU Wan training currently supports only "
                         "training.data.preprocessed_data_type='t2v', got "
    ...
    return TrainingConfig(
        ...
        tracker=TrackerConfig(
            ...
            project_name=str(tr.get("project_name", "flashgen") or "flashgen"),
        ...
        model=ModelTrainingConfig(
            ...
            min_timestep_ratio=float(m.get("min_timestep_ratio", 0.0) or 0.0),
            max_timestep_ratio=float(m.get("max_timestep_ratio", 1.0) or 1.0),
        ),
        pipeline_config=pipeline_config,
        model_path=model_path,
        dit_precision=str(t.get("dit_precision", "fp32") or "fp32"),
        negative_prompt_embeds_path=str(t.get("negative_prompt_embeds_path", "") or ""),
    )
