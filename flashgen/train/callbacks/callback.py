...
Adapted from FastGen's callback pattern to FlashGen's types.
"""
...
from flashgen.train.utils.instantiate import instantiate
...
_BUILTIN_CALLBACKS: dict[str, str] = {
    "grad_clip": "flashgen.train.callbacks.grad_clip.GradNormClipCallback",
    "ema": "flashgen.train.callbacks.ema.EMACallback",
}
