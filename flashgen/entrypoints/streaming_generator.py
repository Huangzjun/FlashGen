...
from flashgen.entrypoints.video_generator import VideoGenerator
...
from flashgen.worker.multiproc_executor import MultiprocExecutor
...
class StreamingVideoGenerator(VideoGenerator):
    ...
    @classmethod
    def from_fastvideo_args(cls, fastvideo_args: FlashgenArgs) -> "StreamingVideoGenerator":
