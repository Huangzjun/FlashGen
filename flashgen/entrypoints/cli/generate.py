...
from flashgen import VideoGenerator
from flashgen.entrypoints.cli.cli_types import CLISubcommand
from flashgen.entrypoints.cli.inference_config import build_generate_run_config
...
class GenerateSubcommand(CLISubcommand):
    """The `generate` subcommand for the Flashgen CLI"""
    ...
    def validate(self, args: argparse.Namespace) -> None:
        ...
        if not args.config:
            raise ValueError("flashgen generate requires --config PATH; use a nested "
    ...
    def subparser_init(self, subparsers: argparse._SubParsersAction) -> FlexibleArgumentParser:
        generate_parser = subparsers.add_parser(
            ...
            usage="flashgen generate --config RUN_CONFIG [--dotted.override VALUE]")
