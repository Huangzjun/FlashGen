...
from flashgen.attention.backends.abstract import AttentionBackend
from flashgen.logger import init_logger
from flashgen.platforms import AttentionBackendEnum
from flashgen.utils import STR_BACKEND_ENV_VAR, resolve_obj_by_qualname
...
def get_env_variable_attn_backend() -> AttentionBackendEnum | None:
    '''
    Get the backend override specified by the Flashgen attention
...
def _cached_get_attn_backend(
    ...
    # previously forced.
    #
    # THIS SELECTION OVERRIDES THE FLASHGEN_ATTENTION_BACKEND
    ...
    if backend_by_global_setting is not None:
        ...
        backend_by_env_var: str | None = envs.FLASHGEN_ATTENTION_BACKEND
...
def global_force_attn_backend_context_manager(attn_backend: AttentionBackendEnum) -> Generator[None, None, None]:
    '''
    Globally force a Flashgen attention backend override within a
