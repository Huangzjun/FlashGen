...
from flashgen.utils import get_ip, get_distributed_init_method, get_open_port
...
from flashgen.worker.ray_utils import (
    initialize_ray_cluster,
    RayWorkerWrapper,
    ray,
)
from flashgen.worker.ray_env import get_env_vars_to_copy
...
class RayDistributedExecutor(Executor):
    ...
    def _init_workers_ray(self, placement_group: "PlacementGroup", **ray_remote_kwargs):
        ...
        num_gpus = envs.FLASHGEN_RAY_PER_WORKER_GPUS
        ...
        if n_nodes != n_ips:
            raise RuntimeError(f"Every node should have a unique IP address. Got {n_nodes}"
                               ...
                               " network configuration. If you set `FLASHGEN_HOST_IP`"
