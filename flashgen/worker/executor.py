...
from flashgen.utils import init_logger
...
class Executor(ABC):
    ...
    @staticmethod
    def get_class(fastvideo_args: FlashgenArgs) -> type["Executor"]:
        if fastvideo_args.distributed_executor_backend == "mp":
            ...
            from flashgen.worker.ray_distributed_executor import RayDistributedExecutor
