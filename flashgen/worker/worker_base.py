...
from flashgen.worker.gpu_worker import Worker
from flashgen.utils import (run_method, update_environment_variables)
...
class WorkerWrapperBase:
    ...
    def __init__(
        ...
        self.fastvideo_args: FlashgenArgs | None = None
